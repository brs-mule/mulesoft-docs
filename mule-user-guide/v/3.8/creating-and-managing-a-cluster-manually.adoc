...
[TIP]
--
Check link:/mule-user-guide/v/3.8/hardware-and-software-requirements#mule-database-servers[Mule's hardware and software requirements] for a list of supported relational database management systems.

Keep in mind that, from that list, Oracle database support is a link:/release-notes/mule-3.8.0-release-notes#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--
...
|`mule.cluster.multicastgroup` |Multicast group IP address to use. Default value: 224.2.2.3. Custom values may be between 224.0.0.0 and 239.255.255.255.
|`mule.cluster.multicastport` |Multicast port number to use. Default value: 54327.
...
[CAUTION]
--
Oracle database support is a link:/release-notes/mule-3.8.0-release-notes#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--
